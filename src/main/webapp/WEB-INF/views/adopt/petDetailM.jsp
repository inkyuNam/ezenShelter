	...
	<c:if test="${loginUser != null}">
		...
		<script type="text/javascript">
			...
			function add_heart(bnt){
				bnt.value = "❤️";
				alert('관심동물에 등록되었습니다');
				document.frm.action = "addHeartM?p_num="+${pet.p_num};
				document.frm.submit();
			}
			...
			function remove_heart(bnt){
				bnt.value = "🤍"
				alert('관심동물에서 해제되었습니다');
				document.frm.action = "removeHeartM?p_num="+${pet.p_num};
				document.frm.submit();
			}
		</script>
</c:if>
...
<!----------- 입양버튼 ----------->
<c:if test="${loginUser != null}">
	<div style="margin: 0 auto; width:300px;"><a href="adopt_contractM?p_num=${pet.p_num}">
