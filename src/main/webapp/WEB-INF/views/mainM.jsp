...
<%@ include file="include/headerfooter/Mheader.jsp" %>
	...
	<div class="main1" style="margin-top: 50px;">
        ...
        <div  id="slide1" style="position:relative;">
            <div id="slide" style="position:absolute;">
                <a href="reviewBoard"><img src="/images/infoimg2.jpg"  class="inimg" alt="" style="width: 500px" height="300px" ></a>
                <a href="adopt_procudure"><img src="/images/infoimg3.jpg"  class="inimg" alt="" style="width: 500px" height="300px" ></a>
                <a href="company"><img src="/images/infoimg1.jpg"  class="inimg" alt="" style="width: 500px" height="300px" ></a>
            </div>
        </div>
	...
	<div id="help_wrap">
		...
		<form name="hell" method="post" action="helpRequestM">
			<table id="help_tb">		
				<tr>
