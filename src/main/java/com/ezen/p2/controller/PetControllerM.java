...
@Controller
public class PetControllerM {

	@Autowired
	PetService ps;
	
	//입양절차
			@RequestMapping("adopt_procudureM")
			public String adopt_procedure(HttpServletRequest request,Model model) {
				HttpSession session = request.getSession();
				return "adopt/adopt_procedureM";
				
			}
			
			
			//펫 리스트
			@RequestMapping("/petListM")
			public ModelAndView petList(HttpServletRequest request) {
				...
				mav.setViewName("adopt/petListM");
			...
			public ModelAndView petDetail( 
				...
				mav.setViewName("adopt/petDetailM");	
			...
			public String addHeart(@RequestParam("p_num")int p_num,HttpServletRequest request) {
		    	...
		    	return "redirect:/petDetailM?p_num="+p_num;
